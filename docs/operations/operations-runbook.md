...
- Publish/refresh via the `build_gmai_genie_agent_cdi_metric_view` job (`resources/semantics_jobs.yml`, notebook `src/semantics/create_gmai_genie_agent_cdi_metric_view.py`).
